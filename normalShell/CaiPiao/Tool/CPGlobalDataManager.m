...
static CPGlobalDataManager *shareGlobalData;

@interface CPGlobalDataManager()
{
...
@implementation CPGlobalDataManager

+(CPGlobalDataManager *)shareGlobalData{
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        
        shareGlobalData = [CPGlobalDataManager new];
...
+(void)playButtonClickVoice
{
    
    return;
    //播放系统音效
    AudioServicesPlaySystemSound([CPGlobalDataManager shareGlobalData]->soundFileObject);
