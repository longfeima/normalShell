...
@interface CPBuyLetterLotterySectionView()
{
...
@implementation CPBuyLetterLotterySectionView
...
-(void)setIsShowDetail:(BOOL)isShowDetail
{
    ...
    self.height = height;
    if (self.delegate && [self.delegate respondsToSelector:@selector(buyLetterLotteryClickShowDetailAction)]) {
        [self.delegate buyLetterLotteryClickShowDetailAction];
    }
