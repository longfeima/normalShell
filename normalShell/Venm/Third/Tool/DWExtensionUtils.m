...
-(NSString *)DWStringByAppendingPathComponent:(NSString *)component
{
    NSString *newString = [self stringByAppendingPathComponent:component];
    if ([newString hasPrefix:@"https:/"]&&![newString hasPrefix:@"https://"]) {
        newString = [newString stringByReplacingOccurrencesOfString:@"https:/" withString:@"https://"];
    }else if ([newString hasPrefix:@"http:/"]&&![newString hasPrefix:@"http://"]){
        newString = [newString stringByReplacingOccurrencesOfString:@"http:/" withString:@"http://"];
