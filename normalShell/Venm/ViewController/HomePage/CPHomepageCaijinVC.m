...
- (void)viewDidLoad {
    ...
    _phoneTf.text = self.caijin.phone?self.caijin.phone:@"";
...
- (IBAction)buttonActions:(UIButton *)sender {
    ...
    switch (sender.tag) {
        case 101:
        {
            //发送验证码
            if (_phoneTf.text.length == 0) {
                [SVProgressHUD way_showInfoCanTouchWithStatus:@"请输入手机号码" dismissAfterInterval:1.0f onView:self.view];
            }else{
...
-(void)querySendPhoneCode
{
    ...
    [paramsDic setObject:_phoneTf.text forKey:@"phone"];
