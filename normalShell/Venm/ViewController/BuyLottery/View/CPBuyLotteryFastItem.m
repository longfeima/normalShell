...
@interface CPBuyLotteryFastItem ()
...
@implementation CPBuyLotteryFastItem
                  ...
                  clickAction:(CPBuyLotteryFastItemClickAction)action
{
    ...
    if (self) {
        ...
        self.bottomLabel.text = [NSString stringWithFormat:@"%@",[[[CPBuyLotteryManager shareManager]fetchDoubleFacePlayBounsByPlayId:[self.buyInfo DWStringForKey:@"playId"]]jdM]];
                     ...
                     buyInfo:(NSDictionary *)buyInfo
{
    ...
    if (self) {
        self.bottomLabel.text = [[[CPBuyLotteryManager shareManager]fetchDoubleFacePlayBounsByPlayId:[self.buyInfo DWStringForKey:@"playId"]]jdM];
    }
    return self;
}
...
{
    CPBuyLotteryFastItem *item = [[CPBuyLotteryFastItem alloc]initWithFrame:frame buyInfo:buyInfo clickAction:acion];
...
{
    CPBuyLotteryFastItem *item = [[CPBuyLotteryFastItem alloc]initWithFrame:frame buyInfo:buyInfo];
