...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *info = _dataList[indexPath.row];
    [self queryDetailInfoWithId:[info DWStringForKey:@"id"] betRecordInfo:info];
...
-(void)queryDetailInfoWithId:(NSString *)infoId
               betRecordInfo:(NSDictionary *)betRecordInfo;
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
           ...
           completionBlockWithSuccess:^(__kindof SUMRequest *request) {
               ...
               CPBetRecordDetailVC *toWebVC = [[CPBetRecordDetailVC alloc]cpWebWithURLString:nil];
               toWebVC.title = @"详情";
               ...
               toWebVC.betRecordInfo = betRecordInfo;
