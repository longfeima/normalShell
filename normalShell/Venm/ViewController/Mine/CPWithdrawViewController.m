...
@interface CPWithdrawViewController ()<UIScrollViewDelegate, UITextFieldDelegate>
{
...
- (void)viewDidLoad {
    ...
    _withdrawAmountTf.keyboardType = UIKeyboardTypeDecimalPad;
    _withdrawPasswordTf.delegate = self;
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    if (textField == _withdrawPasswordTf) {
