...
#import "UIButton+DDSC.h"
#import <objc/runtime.h>
#import "UIControl+FCAcceptEventInteravl.h"

@implementation UIButton(DDSC)
...
- (void)setDD_acceptEventInterval:(NSTimeInterval)DD_acceptEventInterval{
    DD_acceptEventInterval = DD_acceptEventInterval;
    self.Dd_acceptEventInterval = DD_acceptEventInterval;
}

- (BOOL)isHaveNetCanUserful{
    return NO;
