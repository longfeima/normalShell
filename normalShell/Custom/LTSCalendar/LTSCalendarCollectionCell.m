...
- (void)setItem:(LTSCalendarDayItem *)item{
    ...
    dispatch_once(&once, ^{
        ...
        monthArray = @[DSLocalizedString(DS_MON_1),DSLocalizedString(DS_MON_2),DSLocalizedString(DS_MON_3),DSLocalizedString(DS_MON_4),DSLocalizedString(DS_MON_5),DSLocalizedString(DS_MON_6),DSLocalizedString(DS_MON_7),DSLocalizedString(DS_MON_8),DSLocalizedString(DS_MON_9),DSLocalizedString(DS_MON_10),DSLocalizedString(DS_MON_11),DSLocalizedString(DS_MON_12)];
    });
